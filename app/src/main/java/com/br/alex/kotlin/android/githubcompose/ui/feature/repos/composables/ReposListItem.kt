...
@Composable
fun ReposListItem(repo: com.br.alex.kotlin.android.githubcompose.data.model.Repo) {
...
@Composable
fun CounterSession(repo: com.br.alex.kotlin.android.githubcompose.data.model.Repo) {
    Row(
        verticalAlignment = Alignment.CenterVertically,
...
fun UsersListItemPreview() {
    ReposListItem(repo = com.br.alex.kotlin.android.githubcompose.data.model.RepoPreview.repo)
}
