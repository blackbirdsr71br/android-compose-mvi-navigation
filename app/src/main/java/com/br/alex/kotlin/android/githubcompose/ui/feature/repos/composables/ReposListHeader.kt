...
import com.br.alex.kotlin.android.githubcompose.ui.feature.common.RoundedImage
import com.br.alex.kotlin.android.githubcompose.ui.theme.OnSurfaceBackgroundAlpha
import com.br.alex.kotlin.android.githubcompose.ui.theme.OnSurfaceTextAlpha
import com.br.alex.kotlin.android.githubcompose.R
import java.util.*

@Composable
fun ReposListHeader(userDetail: com.br.alex.kotlin.android.githubcompose.data.model.UserDetail) {
...
@Composable
fun ScoreSession(userDetail: com.br.alex.kotlin.android.githubcompose.data.model.UserDetail) {
    Row(
...
@Composable
fun UserDetailSession(userDetail: com.br.alex.kotlin.android.githubcompose.data.model.UserDetail) {
    Text(
...
@Composable
fun ButtonsSession(userDetail: com.br.alex.kotlin.android.githubcompose.data.model.UserDetail) {
    // See all button
    val context = LocalContext.current
    val profileIntent = remember{
        com.br.alex.kotlin.android.githubcompose.common.buildUrlIntent(
            userDetail.htmlUrl
        )
    }
...
fun ReposUserDetailPreview() {
    ReposListHeader(userDetail = com.br.alex.kotlin.android.githubcompose.data.model.buildUserDetailPreview())
}
