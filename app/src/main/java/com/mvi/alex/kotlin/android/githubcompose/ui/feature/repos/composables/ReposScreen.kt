...
import com.mvi.alex.kotlin.android.githubcompose.ui.base.SIDE_EFFECTS_KEY
import com.mvi.alex.kotlin.android.githubcompose.ui.feature.common.NetworkError
import com.mvi.alex.kotlin.android.githubcompose.ui.feature.common.Progress
...
fun ReposScreenSuccessPreview() {
    val repos = List(3) { com.mvi.alex.kotlin.android.githubcompose.data.model.RepoPreview.repo }
    ReposScreen(
        state = ReposContract.State(
            user = com.mvi.alex.kotlin.android.githubcompose.data.model.buildUserDetailPreview(),
            reposList = repos,
            isUserLoading = false,
