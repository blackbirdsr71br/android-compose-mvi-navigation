...
@Composable
fun ReposListItem(repo: com.mvi.alex.kotlin.android.githubcompose.data.model.Repo) {
    val paddingXXSmall = dimensionResource(id = R.dimen.padding_xxsmall)
    val paddingSmall = dimensionResource(id = R.dimen.padding_small)
    val paddingMedium = dimensionResource(id = R.dimen.padding_medium)

    val context = LocalContext.current
    val visitRepoIntent = remember {
...
@Composable
fun CounterSession(repo: com.mvi.alex.kotlin.android.githubcompose.data.model.Repo) {
    Row(
        verticalAlignment = Alignment.CenterVertically,
...
fun UsersListItemPreview() {
    ReposListItem(repo = com.mvi.alex.kotlin.android.githubcompose.data.model.RepoPreview.repo)
}
