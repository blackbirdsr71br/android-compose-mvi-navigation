...
@Composable
fun UsersListItem(
    user: com.mvi.alex.kotlin.android.githubcompose.data.model.User,
...
fun UsersListItemPreview() {
    UsersListItem(user = com.mvi.alex.kotlin.android.githubcompose.data.model.buildUserPreview(), onItemClick = {})
}
