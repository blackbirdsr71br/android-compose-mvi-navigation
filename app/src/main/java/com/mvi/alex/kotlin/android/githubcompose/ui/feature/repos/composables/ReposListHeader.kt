package com.mvi.alex.kotlin.android.githubcompose.ui.feature.repos.composables
...
import com.mvi.alex.kotlin.android.githubcompose.R


import com.mvi.alex.kotlin.android.githubcompose.ui.feature.common.RoundedImage
import com.mvi.alex.kotlin.android.githubcompose.ui.theme.OnSurfaceBackgroundAlpha
import com.mvi.alex.kotlin.android.githubcompose.ui.theme.OnSurfaceTextAlpha
import java.util.*

@Composable
fun ReposListHeader(userDetail: com.mvi.alex.kotlin.android.githubcompose.data.model.UserDetail) {
...
@Composable
fun ScoreSession(userDetail: com.mvi.alex.kotlin.android.githubcompose.data.model.UserDetail) {
    Row(
...
@Composable
fun UserDetailSession(userDetail: com.mvi.alex.kotlin.android.githubcompose.data.model.UserDetail) {
    Text(
...
@Composable
fun ButtonsSession(userDetail: com.mvi.alex.kotlin.android.githubcompose.data.model.UserDetail) {
    // See all button
    val context = LocalContext.current
    val profileIntent = remember{
        com.mvi.alex.kotlin.android.githubcompose.common.buildUrlIntent(
            userDetail.htmlUrl
        )
    }
    val blogIntent = remember{
        com.mvi.alex.kotlin.android.githubcompose.common.buildUrlIntent(
            userDetail.blogUrl
        )
    }
...
fun ReposUserDetailPreview() {
    ReposListHeader(userDetail = com.mvi.alex.kotlin.android.githubcompose.data.model.buildUserDetailPreview())
}
